              ...
              <table className="min-w-full text-left">
                <thead className="bg-gray-50 text-gray-500 text-xs uppercase">
                  <tr>
                    ...
                    <th className="px-3 sm:px-4 md:px-6 py-3 sm:py-4 font-medium hidden md:table-cell">
                      Location
                    </th>
                    <th className="px-3 sm:px-4 md:px-6 py-3 sm:py-4 font-medium">
                      Price/Day
                    ...
                    <th className="px-3 sm:px-4 md:px-6 py-3 sm:py-4 font-medium hidden lg:table-cell">
                      Actions
                    </th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-gray-100">
                  {MOCK_VEHICLES.map((vehicle) => (
                    <tr key={vehicle.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-3 sm:px-4 md:px-6 py-3 sm:py-4 text-xs sm:text-sm text-gray-600 max-w-xs truncate hidden md:table-cell">
                        {vehicle.address}
                      </td>
